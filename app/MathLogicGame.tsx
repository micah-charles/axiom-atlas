...
function AdvancedWorld({ onBack, completeLevel, sound }: GameProps) {
  ...
  if (level.concept === "matrix transformations" || level.concept === "determinant" || level.concept === "Jacobian") return <MatrixWorld mode={level.concept as MatrixMode} level={level} onBack={onBack} completeLevel={completeLevel} sound={sound} />;
