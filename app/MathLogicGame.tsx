...
function SurfaceWorld({ level, onBack, completeLevel, sound }: Pick<GameProps, "onBack" | "completeLevel" | "sound"> & { level: AdvancedLevelDefinition }) {
  const [tilt, setTilt] = useState(0); const [azimuth, setAzimuth] = useState(0); const [area, setArea] = useState(1); const [observations, setObservations] = useState(0);
