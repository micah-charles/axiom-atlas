...
function MatrixWorld({ mode, level, onBack, completeLevel, sound }: Pick<GameProps, "onBack" | "completeLevel" | "sound"> & { mode: MatrixMode; level: AdvancedLevelDefinition }) {
  const [angle, setAngle] = useState(30); const [stretch, setStretch] = useState(1.5); const [shear, setShear] = useState(0); const [order, setOrder] = useState<"rotate-stretch" | "stretch-rotate">("rotate-stretch"); const [observations, setObservations] = useState(0);
