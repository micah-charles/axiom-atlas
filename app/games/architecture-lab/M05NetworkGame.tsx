...
export default function M05NetworkGame() {
  ...
  return <main className="arch-lab-shell arch-m05-shell">
    ...
    <div className="arch-lab-layout">
      <aside className="arch-lab-brief"><span className="arch-overline">MISSION {phase === "complete" ? "COMPLETE" : "05"}</span><h1>The wait is part of the system.</h1><p>After M04, the database has its own host. Follow a request across the new boundary, then decide what the caller should do while the dependency is unavailable.</p><div className="arch-objective"><span>OBJECTIVE</span><b>Prove the dependency, predict both call policies, and explain why a bound changes the outcome.</b></div><div className="arch-brief-facts"><span><i>01</i> inspect neutral evidence</span><span><i>02</i> predict before reveal</span><span><i>03</i> bound the waiting</span></div><div className="arch-fiction-note"><b>ATLAS MARKET IS FICTIONAL</b><span>Source-backed topology is separated from the fictional incident and labelled teaching-simulation values.</span></div></aside>
