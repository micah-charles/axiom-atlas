...
export default function ClimateDetectiveGame({ onBack }: { onBack: () => void }) {
  ...
  const resetMissionState = () => { setSelectedEvidence([]); setChain([]); setAnswer(""); setForecast(initialForecast); setResult(null); setRevealDate(null); setReflection(""); setActiveLayer("none"); setSelectedPressureCentre(null); setPressureTutorialSeen(false); setGuidedTask("complete"); setTaskMessage(""); setHintsUsed(0); setCausalOptionOrder([]); setStoryFocus(null); setReplayCursor(null); };
