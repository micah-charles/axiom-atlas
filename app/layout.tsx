...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = "Think with your hands. Master sorting, trees and quadratic transformations through direct manipulation.";
  return {
    ...
    openGraph: { title: "The Axiom Atlas", description, type: "website", images: [{ url: socialImage, width: 1200, height: 630, alt: "The four mathematical realms of The Axiom Atlas" }] },
