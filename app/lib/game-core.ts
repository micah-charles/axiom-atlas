...
export const BUBBLE_LEVELS = [
  { id: "bubble-01", name: "First Light", values: [7, 3, 5, 2], guided: true, targetStars: 7 },
  { id: "bubble-02", name: "Market Rush", values: [4, 1, 3, 2, 5], guided: false, targetStars: 9 },
  { id: "bubble-03", name: "Lantern Run", values: [6, 2, 8, 3, 1, 7], guided: false, targetStars: 15 },
  { id: "bubble-04", name: "Stable Festival", values: [4, 2, 4, 1, 2], guided: false, targetStars: 10, stable: true },
] as const;
...
export const TREE_LEVELS = [
  { id: "tree-01", name: "Seedling Path", values: [6, 2, 8, 4, 1], duplicatePolicy: "right" as const },
  { id: "tree-02", name: "Canopy Logic", values: [5, 3, 7, 2, 4, 6, 9], duplicatePolicy: "right" as const },
  { id: "tree-03", name: "Twin Blossoms", values: [6, 3, 8, 3, 5, 8, 7], duplicatePolicy: "right" as const },
] as const;
...
export type QuadraticLevel = { id: string; name: string; start: QuadraticState; target: QuadraticState; enabled: (keyof QuadraticState)[] };
export const QUADRATIC_LEVELS: QuadraticLevel[] = [
  { id: "parabola-01", name: "Vertex Awakening", start: { a: 1, h: 0, k: 0 }, target: { a: 1, h: 2, k: 3 }, enabled: ["h", "k"] },
  { id: "parabola-02", name: "Crystal Stretch", start: { a: 1, h: 0, k: 0 }, target: { a: 2, h: -2, k: 1 }, enabled: ["a", "h", "k"] },
  { id: "parabola-03", name: "Mirror Chasm", start: { a: 1, h: 1, k: -2 }, target: { a: -1, h: 1, k: -2 }, enabled: ["a"] },
  { id: "parabola-04", name: "Royal Convergence", start: { a: 1, h: 0, k: 0 }, target: { a: -0.5, h: 3, k: 2 }, enabled: ["a", "h", "k"] },
];
