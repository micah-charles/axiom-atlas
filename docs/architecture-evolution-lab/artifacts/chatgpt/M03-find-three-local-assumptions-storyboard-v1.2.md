...
Total: **100 points**.
  ...
  Category                                       Max Rule
  --------------------- ---------------------------- ---------------------
  Investigation                                   15 All five required
                                                     evidence cards inspected
...
Examples:
- E01+E02+E03+E04 → locked;
- E01+E03+E04+E05 → locked; E02 unseen;
- E02+E03+E04+E05 → locked; E01 unseen;
- E01+E02+E03+E05 → locked; E04 unseen;
- E01+E02+E03+E04+E05 → locked.

## M03-T005 --- Classification requires all four

Commit blocked until E01--E04 each have been inspected and each has a classification.

## M03-T005A --- Missing-card lock / no unseen-answer path

With any answer-bearing E01, E02, or E03 uninspected:
- board remains locked;
- direct classification mutation for that item is rejected;
- commit is rejected;
- no correctness/result text reveals that item's placement answer.
After the missing item and all other evidence are inspected, normal classification may unlock.
...
classification:
  ...
  require_item_inspected_before_mutation: true
  commit_requires_all_items_inspected: true
  allowed_values:
    - UNCLASSIFIED
    - BOUND_TO_HOST_01
    - NOT_PROVEN_LOCAL
...
Narrow editorial consistency fix only.

- Added `M03-T005A` to the machine-readable `test_ids` registry in sequence after `M03-T005`.
- No gameplay, scope, evidence gate, scoring, provenance, experiment, replay, or M04–M06 deferral changed.

## v1.1

Bounded evidence-gate correction only.

- Classification now requires inspection of all five evidence cards E01–E05.
- Removed the minimum-four / E01-or-E02 unlock path.
- Added state-level rejection of classification/commit for any uninspected E01–E04 item.
- Updated state gates, S02, classification semantics, scoring wording, T004, handoff YAML and reviewer checklist.
- Added stable regression `M03-T005A` for missing-card lock/no-answer leakage.
- All other accepted M03 contracts remain unchanged.
