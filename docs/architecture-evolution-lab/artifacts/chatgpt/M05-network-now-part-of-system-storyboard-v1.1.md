...
> **Artifact:** `M05-network-now-part-of-system-storyboard-v1.1.md`  
...
Both policy prediction sets must be committed before either controlled result can reveal.
...
Under the 2-second outage, both affected requests remain waiting at experiment end; no dependency error is surfaced in the lab window; fixed slot count is unchanged.

## M05-T014 — Bounded deterministic timeline

Attempt 1 times out at 0.75 lab seconds; retry begins after 0.25 lab seconds; retry times out at 1.75 lab seconds; error is surfaced before the 2-second window ends.
